...
/**
 * static-web-server config (TOML) for a per-app oister shell image.
...
export function renderSwsConfig() {
  return [
    "# static-web-server config for a generated oister app shell.",
    "# GENERATED by @cobdfamily/cobd-app-generator — do not edit.",
    "[general]",
    'host = "0.0.0.0"',
    "port = 8080",
    'root = "/public"',
 ...
 *   docker build -t cobdfamily/oister-<appId-with-dashes> .
 */
...
# GENERATED by @cobdfamily/cobd-app-generator — do not edit.
# Serves this app's oister shell (the webDir) for a remote / server.url
# deployment. Build from the app's output dir:
#   docker build -t cobdfamily/oister-${repo} .
